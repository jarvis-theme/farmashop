    ...
    <div class="wrap reset">
        <div class="row-fluid">
                    ...
                    <div class="tab-pane active" id="login">
                        <form class="form-horizontal" action="{{url('member/login')}}" method="post">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="inputbox" type="email" name="email" id="inputEmail" required>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="inputPassword">Password</label>
                                <div class="controls">
                                    <input class="inputbox" type="password" name="password" id="inputPassword" required >
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="controls">
                    ...
                    <div class="tab-pane" id="forgot">
                        <form class="form-horizontal" action="{{url('member/forgetpassword')}}" method="post">
                            <div class="control-group">
                                <label class="control-label" for="inputEmail"> Email</label>
                                <div class="controls">
                                    <input class="inputbox" type="email" id="inputEmail" name="recoveryEmail" required>
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="controls">
            ...
            <div class="span5 pull-right">
                <p class="title-create">Pelanggan Baru</p>
                <hr>
